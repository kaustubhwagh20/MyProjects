...
public class product_rule extends AppCompatActivity {
    LinearLayout list;
    EditText size;
    Button load;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t.setText(R.string.product_rule);
        ...
        cal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(product_rule.this, result_product.class);
                intent.putExtra("resultarray",resultarr);
                intent.putExtra("multipliaction",multiplication);
